...
from sentence_transformers import SentenceTransformer      # type: ignore # To generate Embeddings of text
from sklearn.metrics.pairwise import cosine_similarity     # type: ignore # To get Similarity Score of Resume and Job Description
from groq import Groq                             # type: ignore # API to use LLM's
...
def get_report(resume,job_desc):
    client = Groq(api_key="    client = Groq(api_key="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")
")
